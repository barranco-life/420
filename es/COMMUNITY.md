[Encuentro Nacional 4/20²⁶](./README.md) > Comunidad

# Comunidad

![Comunidad](./assets/COMMUNITY.jpg)

**Encuentro Nacional 4/20²⁶ Pro-Legalización 🌿**
*Celebración cultural replicable de ingreso y participación libre*

> 🌿 La comunidad 4/20 no empieza ni termina en este repositorio. Y no para en abril. Este repositorio puede ayudar a que esa comunidad se entienda mejor a sí misma, se articule con más claridad y se vuelva más visible sin perder su humanidad.

> 🌿 Para gran parte del público, una de las formas más útiles de ayudar en la estrategia pro-legalización es compartir todo lo referente al encuentro durante todo el año: links, posts, materiales, reflexiones y otras señales de que la conversación ya está viva.
...
La comunidad real vive primero en sus vínculos, en sus conversaciones y en sus formas de aparecer en el mundo.

Sus espacios más directos y activos viven en WhatsApp. La arquitectura tiene lógica propia:

**Chat general:**
[Chat 4/20²⁶ 🌿](https://chat.whatsapp.com/LGRvbEMEBZ8HruAqFBUoSE) — espacio amplio y abierto donde cualquiera puede compartir libremente lo que quiera relacionado con el movimiento. No es el hub central de trabajo post-evento — es un espacio de sharing.

**Puentes post-evento centrales:**
- [Cómo (y por qué) organizar un 4/20 🌿](https://chat.whatsapp.com/DoFrA1mNgShCiOW2X84DSn) — replicación, conversación y siguientes pasos hacia 4/20²⁷. Este grupo es el puente principal para quien quiere organizar, conocer la movida o contribuir a que crezca.
- [Aportes al Manual 4/20 🌿](https://chat.whatsapp.com/Fn2BXILT6Rj9TYdWgM7uF6) — canal principal para aportes de contenido al Manual 4/20 🌿.

**Grupos temáticos de apoyo:**
...
[La Paz](https://chat.whatsapp.com/JCVnlJgnL78G7S3ejXSL52) · [Cochabamba](https://chat.whatsapp.com/Be6udeZmtBV6lGgMSsXAWz) · [Potosí](https://chat.whatsapp.com/HMNS1eCZ9bY36FcpFbT5Kp) · [Santa Cruz](https://chat.whatsapp.com/I9z6mOAEsfJ5wFHwNvvEer) · [Tarija](https://chat.whatsapp.com/DOEQk4gdyr10MIAmKNyQxa) · [Chuquisaca](https://chat.whatsapp.com/Jjkf5BeKZ99C482SEh6Gaj) · [Oruro](https://chat.whatsapp.com/L96GjiiFHhiL8TT36wcG5b)
...
## La comunidad post-evento no espera hasta abril

Una de las apuestas importantes es que la comunidad no duerma entre ediciones.

Compartir información, eventos, materiales, reflexiones y señales de la movida 4/20 durante todo el año — no solo en abril — es parte de la estrategia de visibilización. Cada expresión pública, cada conversación, cada celebración que se suma ayuda a hacer el tema cada vez más presente e imposible de ignorar.

Algunos ejemplos de cómo puede sostenerse la comunidad durante el año:

- Compartir noticias o avances sobre políticas cannábicas, en Bolivia y en el mundo.
- Aportar al Manual 4/20 desde experiencia propia, salud, cultura o derecho.
- Organizar o visibilizar eventos 4/20 en territorios o espacios propios.
- Explorar la conversación sobre cómo y por qué organizar un 4/20.
- Sostener vínculos con personas y espacios que resonaron con el espíritu del encuentro.
...
Esta estructura por capas evita un error frecuente: creer que la única manera válida de sumarse es "meterse de lleno" o exponerse demasiado. La comunidad también crece cuando se vuelve más porosa, más hospitalaria y más fácil de habitar desde distintos niveles.
...
El encuentro 4/20 dialoga profundamente con el espíritu de [Voluntariado Barranco](https://voluntariado.barranco.life/).

El 4/20²⁶ en el Barranco confirmó algo: el cannabis no fue el centro social más profundo. El centro más hondo fue la manera alternativa de organizarnos — co-crear, adaptarnos, cuidar el espacio, colaborar, participar y estar juntos entre personas diversas.
...
- Sumándose al grupo de su territorio.
- Aportando al [Manual 4/20 🌿](https://manual420.barranco.life) desde [Aportes al Manual 4/20 🌿](https://chat.whatsapp.com/Fn2BXILT6Rj9TYdWgM7uF6).
- Conversando sobre cómo organizar un 4/20 desde [Cómo (y por qué) organizar un 4/20 🌿](https://chat.whatsapp.com/DoFrA1mNgShCiOW2X84DSn).
...
- Sumándose a [Voluntariado Barranco](https://voluntariado.barranco.life/) si el espíritu más profundo del Barranco resonó.
...
Y también importa recordar algo básico: _el encuentro no promueve vulnerar la Ley 1008; la responsabilidad es individual_.
