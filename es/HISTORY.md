...
- **Versión siempre actualizada de este documento:** https://github.com/barranco-life/420/blob/main/es/HISTORY.md

## Índice

- [Qué busca registrar este archivo](#qué-busca-registrar-este-archivo)
- [Por qué importa esta historia](#por-qué-importa-esta-historia)
- [2022 · Primer gran encuentro en Proyecto Cultural Barranco](#2022--primer-gran-encuentro-en-proyecto-cultural-barranco)
- [2023 · Protocolo, tres escenarios y primer aprendizaje fuerte de contención](#2023--protocolo-tres-escenarios-y-primer-aprendizaje-fuerte-de-contención)
- [2024 · Continuidad, comunidad y maduración interna](#2024--continuidad-comunidad-y-maduración-interna)
- [2025 · Formulario, expansión conceptual y antesala del giro 2026](#2025--formulario-expansión-conceptual-y-antesala-del-giro-2026)
- [Lo que fue quedando claro](#lo-que-fue-quedando-claro)
- [Qué cambia en 2026](#qué-cambia-en-2026)
- [Relación con otros documentos](#relación-con-otros-documentos)
- [Cierre](#cierre)

## Qué busca registrar este archivo

Este documento no busca construir una historia inflada ni heroica del encuentro. Busca registrar, de manera útil y legible, cómo fue madurando esta experiencia y qué aprendizajes dejó en el camino.
...
El encuentro de 2022 fue el primer gran hito del proceso. Cayó en un día laboral y, aun así, reunió a una cantidad muy significativa de personas en **Proyecto Cultural Barranco**.
...
Ese año todavía pesaba más una lógica de “gran encuentro” que una lógica de red replicable. Pero ya estaban presentes varias semillas de lo que vendría después:
...
## 2023 · Protocolo, tres escenarios y primer aprendizaje fuerte de contención

El encuentro de 2023 consolidó varias cosas y tensó otras. Hubo tres escenarios simultáneos, una convocatoria artística amplia y un esfuerzo más claro por organizar el evento con una lógica preventiva y no improvisada.
...
## 2024 · Continuidad, comunidad y maduración interna

El ciclo 2024 ayudó a sostener la continuidad del encuentro y a consolidar la comunidad que se reunía alrededor de esta fecha. Aunque no todo quedó documentado con el mismo nivel de detalle, el proceso siguió decantando preguntas importantes.
...
En perspectiva, 2024 parece menos importante por una innovación puntual y más por haber sostenido la llama y permitir que el proyecto siguiera madurando por dentro.

[Volver al índice](#índice)

## 2025 · Formulario, expansión conceptual y antesala del giro 2026
...
- Que los **espacios anfitriones** son una de las claves más importantes del modelo.
...
- **Proyecto Cultural Barranco** como caso de referencia documentado.
- **Voluntariado Barranco** como puente filosófico y organizativo.
- **Espacios anfitriones** como centro estratégico de expansión.
...
- **Manual 4/20** como capa de contexto, memoria y educación.
- **Pliego petitorio** como dimensión ciudadana abierta a contribuciones.

También cambia el tono y la estrategia: menos búsqueda de choque, más hospitalidad; menos reacción, más ejemplo; menos obsesión por empujar una postura, más interés en mostrar una posibilidad social difícil de reducir a prejuicios. La apuesta es que, mientras la comunidad 4/20, sus celebraciones, sus expresiones culturales y el propio debate se vuelvan cada vez más visibles en la vida pública, más probable será que el tema se consolide como asunto de interés general. En ese sentido, el crecimiento cultural del 4/20 se parece más a la forma en que celebraciones como Halloween se volvieron socialmente inevitables que a una lógica de confrontación permanente.
...
La historia del encuentro no está terminada. Pero ya dejó suficientes señales como para decir algo importante: esto no nació ayer, no apareció de la nada y no depende solo de una consigna.

Lo que hoy se quiere abrir en 2026 se apoya en años de experiencia real, comunidad, intuición, errores, contención, celebración y aprendizaje. Esa memoria no está aquí para inflarse; está aquí para ayudar a que lo que venga sea más claro, más honesto y más útil.

[Volver al índice](#índice)

https://github.com/barranco-life/420/blob/main/es/HISTORY.md
